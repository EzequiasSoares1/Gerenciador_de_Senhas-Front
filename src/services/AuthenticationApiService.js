...
import {TOKEN, LOGGER_USER} from './ApiService';
...
export class AuthenticationApiService extends ApiService {
    ...
    async login(username, password){
        ...
        try{   
            ...
            this.storageService.setItem(LOGGER_USER, user);
   ...
   isTokenValid(token){
    ...
    logout(){
        this.storageService.removeItem(LOGGER_USER);
    ...
    getLoggedUser(){
        return this.storageService.getItem(LOGGER_USER);
    }
